...
%
% Note: This is an ERPLAB function that was heavily altered by Benedikt
% Ehinger to be included in the unfold toolbox. In particular, I removed 
% all the filter-features and changed the input parser.
% Please cite the ERPLAB toolbox if you use this function (reference below).
...
shortisi  = cfg.combineSegments;    % merge adjacent bad intervals?
