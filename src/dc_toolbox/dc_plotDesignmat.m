...
cfg = finputcheck(varargin,...
    {'event_or_full',   'string', {'event','full','deprecated'}, 'deprecated';...
...
if ~strcmp(cfg.event_or_full,'deprecated')
    warning('Hi Olaf! event_or_full is deprecated and I changed to the boolean parameter ''timeexpand'', e.g. timeexpand=1 means the old ''full''.')
    switch cfg.event_or_full
        case 'full'
            cfg.timeexpand = 1;
    end
end
if cfg.timeexpand
    ...
    time_lim = EEG.times(ceil(end/2)) + [-500,500] * 1000;
