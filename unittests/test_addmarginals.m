...
unfold3 = uf_predictContinuous(unfold,'method','average');
ufresult = uf_predictContinuous(unfold,'predictAt',{{'continuousA',[0 1]},{'contB',[0 1]},{'splineA',[-1 0 1]}});
unfold2 = uf_addmarginal(unfold);
