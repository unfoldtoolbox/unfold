...
html_static_path = ['_static', '../../docs/tutorials/','../../docs/css/']
...
latex_documents = [
    (master_doc, 'unfold.tex', u'Unfold Documentation',
     u'Benedikt Ehinger, Olaf Dimigen', 'manual'),
]
...
def setup(app):
    app.add_stylesheet('doc_style.css')
